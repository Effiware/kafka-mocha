...
@mock_consumer(inputs=[{"source": LOCAL_INPUT, "topic": TOPIC_NAME, "serialize": False}], loglevel="INFO")
def consume_preloaded_messages():
    ...
    """
    consumer = confluent_kafka.Consumer({"bootstrap.servers": "localhost:9092", "group.id": "test-group", "auto.offset.reset": "earliest"})
